...
Project of [Getting and Cleaning Data course on Coursera](https://www.coursera.org/course/getdata), January 2015 edition.
...
* __tidyData.txt__: Tidy data set generated by run_analysis.R script

## How to create the tidy data set

1. clone this repository: `git clone git@github.com:dellins/Getting-and-Cleaning-Data-Project.git`
